...
input ENUM_TIMEFRAMES mainPeriod = 0; // main timeframes
input ENUM_TIMEFRAMES subPeriod = 0; // sub timeframes
...
int OnInit() {
   ...
   POST_MESSAGE(EA_NAME, StringFormat("[INFO] start: %s, unit=%f, mainPeriod=%s", Symbol(), unit, getPeriodName(mainPeriod)));
