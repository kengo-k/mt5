...
#include <Custom/v2/Strategy/GridStrategy/01/Logic/CheckTrend/CheckTrend2ma.mqh>
#include <Custom/v2/Strategy/GridStrategy/01/Logic/GetEntryCommand/GetEntryCommand2ma.mqh>
...
// 以下global変数に値を設定する
string EA_NAME = "gridstrategy01-02";
