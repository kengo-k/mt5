 ...
 * ・指定した期間経過後にプラスポジションのみ決済する(マイナスは持ち越す)
 * ・負け越しはトレンド転換時にすべて決済する
 */
...
#include <Custom/v2/Strategy/GridStrategy/01/Logic/CloseHedgePositions/CloseHedgePositionsOnlyWhenEndOfTimeframe2.mqh>
...
input int ORDER_GRID_SIZE = 20;
input int HEDGE_GRID_SIZE = 10;

// 以下global変数に値を設定する
string EA_NAME = "gridstrategy01-07";
